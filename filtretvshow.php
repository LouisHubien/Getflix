...
if($_SESSION['adult']==0){
	if(isset($_GET['genre'])){
		...
		if($_GET['genre']=="action"){
			$reponse = $bdd->query('SELECT * FROM entities WHERE movies=0 AND categoryId=1 AND adult=0');
			...
			$reponse = $bdd->query('SELECT * FROM entities WHERE movies=0 AND categoryId=2 AND adult=0');
			while ($donnees = $reponse->fetch())
			{
				echo "<a href=\"video.php?titre=" . $donnees['Name'] . "\"><div class=\"d-inline my-2 mx-2\">" . $donnees['Thumbnails'] . "</div></a>";
			}
			...
			$reponse = $bdd->query('SELECT * FROM entities WHERE movies=0 AND categoryId=3 AND adult=0');
			while ($donnees = $reponse->fetch())
			{
				echo "<a href=\"video.php?titre=" . $donnees['Name'] . "\"><div class=\"d-inline my-2 mx-2\">" . $donnees['Thumbnails'] . "</div></a>";
			}
			...
			$reponse = $bdd->query('SELECT * FROM entities WHERE movies=0 AND categoryId=4 AND adult=0');
			while ($donnees = $reponse->fetch())
			{
				echo "<a href=\"video.php?titre=" . $donnees['Name'] . "\"><div class=\"d-inline my-2 mx-2\">" . $donnees['Thumbnails'] . "</div></a>";
			}
			...
			$reponse = $bdd->query('SELECT * FROM entities WHERE movies=0 AND categoryId=5 AND adult=0');
			while ($donnees = $reponse->fetch())
			{
				echo "<a href=\"video.php?titre=" . $donnees['Name'] . "\"><div class=\"d-inline my-2 mx-2\">" . $donnees['Thumbnails'] . "</div></a>";
			}
			...
			$reponse = $bdd->query('SELECT * FROM entities WHERE movies=0 AND categoryId=6 AND adult=0');
			while ($donnees = $reponse->fetch())
			{
				echo "<a href=\"video.php?titre=" . $donnees['Name'] . "\"><div class=\"d-inline my-2 mx-2\">" . $donnees['Thumbnails'] . "</div></a>";
			}
			...
			$reponse = $bdd->query('SELECT * FROM entities WHERE movies=0 AND categoryId=7 AND adult=0');
			while ($donnees = $reponse->fetch())
			{
				echo "<a href=\"video.php?titre=" . $donnees['Name'] . "\"><div class=\"d-inline my-2 mx-2\">" . $donnees['Thumbnails'] . "</div></a>";
			}
	...
	//SI PAS DE FILTRES
		...
		$reponse = $bdd->query('SELECT * FROM entities WHERE movies=0 AND adult=0');
		while ($donnees = $reponse->fetch())
		{
			echo "<a href=\"video.php?titre=" . $donnees['Name'] . "\"><div class=\"d-inline my-2 mx-2\">" . $donnees['Thumbnails'] . "</div></a>";
		}
